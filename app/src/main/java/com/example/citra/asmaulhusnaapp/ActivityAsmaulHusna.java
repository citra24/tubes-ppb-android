package com.example.citra.asmaulhusnaapp;
...
import com.example.citra.asmaulhusnaapp.adapter.RecyclerViewAdapter;
import com.example.citra.asmaulhusnaapp.adapter.RecyclerViewAdapterBacaan;
...
public class ActivityAsmaulHusna extends AppCompatActivity {
    ...
    public static final String LOG_TAG = ActivityAsmaulHusna.class.getSimpleName();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        private void logoutKan() {
            ...
            editor.commit();
            Intent intent = new Intent(ActivityAsmaulHusna.this, Login.class);
            finish();
